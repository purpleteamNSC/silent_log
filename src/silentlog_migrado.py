...
def get_acess_token():
    ...
    data = {
        "scope": "hlx.alr.r hlx.alr.rw hlx.cc.r hlx.cc.rw hlx.dbr.r hlx.dbr.rw hlx.dp.r hlx.dp.rw hlx.fed.r hlx.fed.rw hlx.hidden.rw hlx.ind.r hlx.ind.rw hlx.intel.rw hlx.org.adm hlx.rul.r hlx.rul.rw hlx.so.r hlx.so.rw hlx.srh.adv hlx.srh.r hlx.srh.rw",
...
def upload_csv_to_helix(company):
    ...
    url = f"https://apps.fireeye.com/helix/id/{helix_id}/api/v3/senders"
...
def enable_silent_log():
    url = f"https://apps.fireeye.com/helix/id/{helix_id}/api/v3/senders/enable"
